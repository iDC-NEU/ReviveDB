...
public:
     ...
     * Generator#nextValue()} call. Calling {@link #lastValue()} should not advance the distribution or have any side
     * effects. If {@link #nextValue()} has not yet been called, {@link #lastValue()} should return something
     * reasonable.
     */
    virtual V lastValue()
    {
...
{
    return ThreadLocalStore<std::default_random_engine>::Get();
}
